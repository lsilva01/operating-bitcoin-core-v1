...
Wallet encryption may also not protect against more sophisticated attacks. An attacker can, for example, obtain the passphrase by installing a keylogger on the user's machine.
